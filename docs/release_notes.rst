...
* Update technology data for `CO2 liquefaction`, i.e. the dense-phase carbon dioxide compression/liquefaction step for transport in large pipelines. (https://github.com/PyPSA/technology-data/pull/273)
