...
latex_documents = [
  (master_doc, 'technologydata.tex', u'Technology-data Documentation',
   u'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'technology-data', u'Technology-data Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'technology-data', u'Technology-data Documentation',
   author, 'technology-data', 'One line description of project.',
   'Miscellaneous'),
]
