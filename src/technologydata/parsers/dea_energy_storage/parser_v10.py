...
class DeaEnergyStorageV10Parser(ParserBase):
    ...
    @staticmethod
    def _drop_invalid_rows(dataframe: pd.DataFrame) -> pd.DataFrame:
        """
    ...
    def _clean_parameter_string(text_string: str) -> str:
        """
    ...
    @staticmethod
    @pydantic.validate_call
    def _clean_technology_string(tech_str: str) -> str:
        """
    ...
    @staticmethod
    @pydantic.validate_call
    def _clean_est_string(est_str: str) -> str:
        """
    ...
    @staticmethod
    def _standardize_units(series: pd.Series) -> pd.Series:
        """
    ...
    @staticmethod
    def _filter_parameters(dataframe: pd.DataFrame, filter_flag: bool) -> pd.DataFrame:
        """
    ...
    def parse(
        ...
        **kwargs : bool
        ...
        cleaned_df = DeaEnergyStorageV10Parser._drop_invalid_rows(dea_energy_storage_df)
        ...
        cleaned_df[["par", "unit"]] = cleaned_df[["par", "unit"]].apply(
            DeaEnergyStorageV10Parser._standardize_units, axis=1
        )
        ...
        cleaned_df["val"] = cleaned_df["val"].apply(
            lambda x: DeaEnergyStorageV10Parser._format_val_number(x, num_digits)
        )
